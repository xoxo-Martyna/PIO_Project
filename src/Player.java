...
public class Player { // implements src.IFightMember {
    private int x;
    private int y;
    ...
    public Player( Game game ) {
        ...
        try {
            down = ImageIO.read( new File("src/res/g_front.png") );

            up = ImageIO.read( new File("src/res/g_back.png") );

            left = ImageIO.read( new File("src/res/g_left.png") );

            right = ImageIO.read( new File("src/res/g_right.png") );
        ...
        //items[0][2] = src.Item.create("flashlight");
        // items[1][1] = src.Item.create( "diamond_sword" );
        // items[2][0] = src.Item.create( "salvia_potion" );
        // items[2][2] = src.Item.create( "ayahuasca_poison" );
        // items[2][1] = src.Item.create( "iron_helmet" );
 
        // items[1][0] = src.Item.create( "strass_sword" );
        // items[1][2] = src.Item.create( "almost_iron_helmet" );
    }
