...
public class ExpPanel extends JPanel implements KeyListener {
    ...
    public ExpPanel( Game game ) {
        ...
        try {
            imageArmor = ImageIO.read(new File("src/res/items/outline_armor.png"));
            imageSword = ImageIO.read(new File("src/res/items/outline_sword.png"));
            // imageFlashlight = ImageIO.read(new File( "src.res/items/outline_flashlight.png" ));
            // imageWeed = ImageIO.read(new File ("src.res/items/outline_weed.png"));

            attackBar = ImageIO.read(new File("src/res/attack_bar.png"));
            defenseBar = ImageIO.read(new File("src/res/defense_bar.png"));
            healthBar = ImageIO.read(new File("src/res/health_bar.png"));
            sidebarOverlay = ImageIO.read(new File("src/res/sidebar.png"));

            boss1BG = ImageIO.read(new File("src/res/background/1boss.png"));
            boss2BG = ImageIO.read(new File("src/res/background/2boss.png"));
            boss3BG = ImageIO.read(new File("src/res/background/3boss.png"));

            standard1BG = ImageIO.read(new File("src/res/background/1standard.png"));
            standard2BG = ImageIO.read(new File("src/res/background/2standard.png"));
            standard3BG = ImageIO.read(new File("src/res/background/3standard.png"));
        } catch ( IOException e ) {
            e.printStackTrace();
        }
